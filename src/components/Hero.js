        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16">
          ...
          >
            ...
            >
              <Link
                href="/projects/"
                className="px-8 py-3.5 bg-gradient-to-r from-[#00E5FF] to-[#00a8cc] text-white font-medium rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-[#00E5FF]/30 hover:scale-[1.02] flex items-center gap-2"
              >
              ...
              <Link
                href="/contact"
                className="px-8 py-3.5 bg-transparent border-2 border-[#FF1F71] text-[#FF1F71] font-medium rounded-lg hover:bg-[#FF1F71]/10 transition-all duration-300 hover:shadow-lg hover:shadow-[#FF1F71]/20 hover:scale-[1.02]"
              >
                Contact Me
              </Link>
            </motion.div>
          ...
          >
            <a href="https://github.com/aditi2911" target="_blank" rel="noopener noreferrer" className="text-2xl text-gray-300 hover:text-white transition-colors duration-300">
              <FaGithub />
            </a>
            <a href="https://www.linkedin.com/in/aditi-rajawat-29a813390" target="_blank" rel="noopener noreferrer" className="text-2xl text-blue-400 hover:text-blue-300 transition-colors duration-300">
              <FaLinkedin />
            </a>
          </motion.div>
        </div>
